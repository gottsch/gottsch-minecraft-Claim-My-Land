...
//            ClaimMyLand.LOGGER.debug("render: CONFLICT_HIGHLIGHT_IDS={}", CONFLICT_HIGHLIGHT_IDS);
    ...
    private static void quad(VertexConsumer consumer, Matrix4f matrix,
                             ...
                             float r, float g, float b, float a) {
        consumer.addVertex(matrix, x0, y0, z0).setColor(r, g, b, a).setUv(u0, v0)
                .setOverlay(OverlayTexture.NO_OVERLAY).setUv2(0xF0, 0xF0).setNormal(0, 1, 0);
        consumer.addVertex(matrix, x1, y1, z1).setColor(r, g, b, a).setUv(u1, v0)
                .setOverlay(OverlayTexture.NO_OVERLAY).setUv2(0xF0, 0xF0).setNormal(0, 1, 0);
        consumer.addVertex(matrix, x2, y2, z2).setColor(r, g, b, a).setUv(u1, v1)
                .setOverlay(OverlayTexture.NO_OVERLAY).setUv2(0xF0, 0xF0).setNormal(0, 1, 0);
        consumer.addVertex(matrix, x3, y3, z3).setColor(r, g, b, a).setUv(u0, v1)
                .setOverlay(OverlayTexture.NO_OVERLAY).setUv2(0xF0, 0xF0).setNormal(0, 1, 0);
    }
    ...
    public static void resolveSprites(TextureAtlas atlas) {
        bufferSprite         = atlas.getSprite(ResourceLocation.fromNamespaceAndPath(ClaimMyLand.MOD_ID, "block/buffer_block"));
        bufferSpriteConflict = atlas.getSprite(ResourceLocation.fromNamespaceAndPath(ClaimMyLand.MOD_ID, "block/buffer_block_conflict"));
        AREA_SPRITES.put(ParcelType.NATION,  atlas.getSprite(ResourceLocation.fromNamespaceAndPath(ClaimMyLand.MOD_ID, "block/blue_horizontal")));
        AREA_SPRITES.put(ParcelType.CITIZEN, atlas.getSprite(ResourceLocation.fromNamespaceAndPath(ClaimMyLand.MOD_ID, "block/purple_horizontal")));
        AREA_SPRITES.put(ParcelType.ZONE,    atlas.getSprite(ResourceLocation.fromNamespaceAndPath(ClaimMyLand.MOD_ID, "block/yellow_horizontal")));
        AREA_SPRITES.put(ParcelType.PLAYER,  atlas.getSprite(ResourceLocation.fromNamespaceAndPath(ClaimMyLand.MOD_ID, "block/green_horizontal")));
    }
}