...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(Provider provider) {
        ...
        tag(ModTags.Items.MAGEFLAME_SCROLLS_WHITELIST)
                .addOptional(ResourceLocation.fromNamespaceAndPath(MF, "mage_flame_scroll"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(MF, "lesser_revelation_scroll"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(MF, "greater_revelation_scroll"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(MF, "bubble_flame_scroll"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(MF, "winged_torch_scroll"))
                .addOptional(ResourceLocation.fromNamespaceAndPath(MF, "ember_hound_scroll"))
        ;

        // Treasure2 is not available yet for Neoforge 1.21.1
