...
public class ParcelPolygonOverlayFactory {
    ...
    private static final Color NATION_FILL = new Color(0x3300AAFF, true);  // was 0x0300AAFF
    ...
    private static final Color ZONE_FILL   = new Color(0x33FFFF55, true);  // was 0x03FFFF55
    ...
    private static void buildConflictOverlayPair(ClientParcel parcel, ResourceKey<Level> dimKey) {
        ...
        PolygonOverlay bufOverlay = new PolygonOverlay(
                ClaimMyLand.MOD_ID, dimKey, bufShape, new MapPolygon(bufCorners));
    ...
    public static PolygonOverlay buildBufferOverlay(ClientParcel parcel) {
        ...
        return new PolygonOverlay(ClaimMyLand.MOD_ID, dimKey, shapeProps, polygon);
    }
    ...
    public static void showPreviewOverlay(UUID parcelId,
        ...
        ShapeProperties shapeProps = new ShapeProperties()
                .setFillColor(fillColor.getRGB() & 0x00FFFFFF)
                .setFillOpacity(fillColor.getAlpha() / 255f)
                .setStrokeColor(strokeColor.getRGB() & 0x00FFFFFF)
                .setStrokeOpacity(strokeColor.getAlpha() / 255f)
                .setStrokeWidth(2f);
        ...
        previewOverlay  = new PolygonOverlay(ClaimMyLand.MOD_ID, dimension, shapeProps, polygon);
        ...
        previewBufferOverlay = new PolygonOverlay(ClaimMyLand.MOD_ID, dimension, bufferShape, new MapPolygon(bufCorners));
