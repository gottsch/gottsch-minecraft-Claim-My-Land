...
import mod.gottsch.neo.claimmyland.core.item.CitizenDeed;
...
//        ClaimMyLand.LOGGER.debug("player {} item access", hasItemAccess ? "has" : "does NOT have");
    ...
    public ClaimResult handleEmbeddedClaim(Level level, Parcel parentParcel) {
        ...
        Optional<ClaimResult> siblingConflict = ParcelHelper.checkDirectSiblingOverlap(this, getBox(), parentParcel, dimension, false);
