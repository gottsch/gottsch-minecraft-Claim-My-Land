...
public class EstateTypeRegistry {
    public static final ResourceLocation ESTATE_TYPE = ResourceLocation.fromNamespaceAndPath(ClaimMyLand.MOD_ID, "estate");
    public static final ResourceLocation NATION_ESTATE_TYPE = ResourceLocation.fromNamespaceAndPath(ClaimMyLand.MOD_ID, "nation_estate");
