...
import mod.gottsch.neo.claimmyland.core.util.StructurePolicyFactory;
...
public class Config extends AbstractConfig {
	...
	public static class Gui {
		public ModConfigSpec.BooleanValue enableProtectionChatMessages;
		public ModConfigSpec.BooleanValue enableParcelEntryTitle;
		public ModConfigSpec.IntValue parcelEntryCooldownSeconds;
	...
	public static class General {
		public ModConfigSpec.IntValue parcelsPerPlayer;
		public ModConfigSpec.IntValue opsPermissionLevel;
		public ModConfigSpec.IntValue parcelBufferRadius;
		public ModConfigSpec.IntValue nationParcelBufferRadius;
		public ModConfigSpec.BooleanValue allowMojangNameCalls;
		public ModConfigSpec.BooleanValue enableParcelEntryTitle;
		public ModConfigSpec.BooleanValue foundationStoneCentered;
		public ModConfigSpec.BooleanValue enableDeedLoot;
		public final ModConfigSpec.ConfigValue<List<? extends String>> opsList;
	...
	public static class Borders {
		public ModConfigSpec.IntValue borderStoneLifeSpan;
		public ModConfigSpec.IntValue foundationStoneLifeSpan;
		public ModConfigSpec.IntValue nationBorderHeight;
		// default 20, min 1, max 256

		Borders(final ModConfigSpec.Builder builder) {
			builder.comment(CATEGORY_DIV, " General properties for Protect It  mod.", CATEGORY_DIV).push(GENERAL_CATEGORY);
	...
	public static class Protection {
		public ModConfigSpec.BooleanValue enableBlockBreakEvent;
		public ModConfigSpec.BooleanValue enableEntityPlaceEvent;
		public ModConfigSpec.BooleanValue enableEntityMultiPlaceEvent;
		public ModConfigSpec.BooleanValue enableBlockToolInteractEvent;
		public ModConfigSpec.BooleanValue enableRightClickBlockEvent;
		public ModConfigSpec.BooleanValue enableRightClickItemEvent;
		public ModConfigSpec.BooleanValue enableLivingDestroyBlockEvent;
		public ModConfigSpec.BooleanValue enablePistionEvent;
		public ModConfigSpec.BooleanValue enableExplosionDetonateEvent;
		public ModConfigSpec.BooleanValue preventFireSpread;
	...
	public static class Backup {
		...
		public final ModConfigSpec.IntValue intervalMinutes;
		public final ModConfigSpec.IntValue maxFiles;

		Backup(final ModConfigSpec.Builder builder) {
			builder.comment(CATEGORY_DIV,
	...
	public static class StructureProtection {
		public final ModConfigSpec.BooleanValue enabled;
		public final ModConfigSpec.ConfigValue<List<? extends String>> denyStructures;
		public final ModConfigSpec.ConfigValue<List<? extends String>> warnStructures;

		StructureProtection(final ModConfigSpec.Builder builder) {
			builder.comment(CATEGORY_DIV,
	...
	public static class Dimensions {
		public final ModConfigSpec.ConfigValue<List<? extends String>> excludedDimensions;

		Dimensions(final ModConfigSpec.Builder builder) {
			builder.comment(CATEGORY_DIV,
	...
	public static class CelebrationConfig {
		public final ModConfigSpec.BooleanValue fireworksEnabled;

		CelebrationConfig(ModConfigSpec.Builder builder) {
	...
	public static class Rendering {
		public ModConfigSpec.IntValue borderRenderRadius;
		public final ModConfigSpec.IntValue conflictHighlightTimeoutSeconds;

		Rendering(final ModConfigSpec.Builder builder) {
			builder.comment(CATEGORY_DIV,
