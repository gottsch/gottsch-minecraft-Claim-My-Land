...
import mod.gottsch.neo.claimmyland.core.parcel.NationParcel;
...
//        }
        ...
        if (stack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().contains(Deed.SIZE)) {
