 ...
 */
public class PersonalFoundationStone extends FoundationStone {

    /**
     *
     * @param properties
     */
    public PersonalFoundationStone(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        ...
        try {
            blockEntity = new PersonalFoundationStoneBlockEntity(pos, state);
        }
        catch(Exception e) {
